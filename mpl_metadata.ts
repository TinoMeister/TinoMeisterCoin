...
async function main(){
    ...
    const myKeypair = loadWalletKey("../../.config/solana/id.json");
    const mint = new web3.PublicKey("TOKEN_KEY");
    ...
    const ourMetadata = { // TODO change those values!
        name: "TinoMeister Coin", 
        symbol: "TMCK",
        uri: "https://raw.githubusercontent.com/TinoMeister/TinoMeisterCoin/main/metadata.json"
    }
